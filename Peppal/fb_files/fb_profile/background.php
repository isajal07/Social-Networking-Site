...
<!--Head background-->
<div style="position:fixed;left:0;top:0; height:7%; width:100%; z-index:1; background:#001A33">   </div>   </div>
<div style="position:fixed;left:4.05%;top:0.8%;font-size:25;font-weight:900; z-index:2;"> <a href="Home.php" style="color:#FFFFFF; text-decoration:none;" onMouseOver="on_head_fb_text()" onMouseOut="out_head_fb_text()">   <img src="background_file/background_icons/logo.png" style="width:14%; height:9%;position:absolute;left:13.5%; top:1%;"/> </a> </div>
...
<form name="fb_search" action="../fb_home/Search_Display_submit.php" method="get" onSubmit="return bcheck()">
	<div style="position:fixed; left:19%; top:1.2%; z-index:2;"> <input type="text" name="search1" placeholder="Search for people" style="height:25; width:300;" onKeyUp="searching();" id="search_text1"> </div>

	<div id="searching_ID"></div>

	<div style="position:fixed; left:42%;top:1.6%; z-index:2;">
...
<div style="position:fixed; left:71.8%; top:0.6%; z-index:2;">
	...
	<tr id="hedarname2">
		...
		<td id="head_name_bg"> <a href="Profile.php" id="head_name_font" style="color:#DEDEEF; font-size:12; font-weight:900;font-family:arial; text-transform:capitalize; text-decoration:none;"> &nbsp;  <?php echo $name; ?> &nbsp;</a> </td>
		<td style="color:#DEDEEF;"> | </td>
		<td id="head_home_bg"> <a href="../fb_home/Home.php" id="head_home_font" style="color:#DEDEEF; font-size:12; font-weight:900;font-family:arial; text-decoration:none;"> &nbsp; Home &nbsp; </a> </td>
        <td style="color:#DEDEEF;">|</td>
	</tr>
	</table>
</div>
...
<div style="position:fixed; left:97%; top:0.4%; z-index:2;"> <img src="background_file/background_icons/nexusae0_home_settings_icon2.png" height="35" width="35" onClick="close_option()"> </div>
        ...
        <div style="position:fixed; left:88%; top:5%; z-index:3;">
                 <a href="Profile.php" style="text-decoration:none; font-family:arial;color:#000;" id="head_timeline" onMouseOver="head_timeline_over()" onMouseOut="head_timeline_out()" ><h4>Timeline</h4></a>
        </div>
        ...
        <div style="position:fixed; left:88%; top:10%; z-index:3;">
                <a href="about.php" style="text-decoration:none; font-family:arial;color:#000;" id="head_about" onMouseOver="head_about_over()" onMouseOut="head_about_out()"><h4>About</h4></a>
        </div>
...
<div style="position:fixed; left:88.2%; top:15%; z-index:3;"><a href="photos.php" style="text-decoration:none; font-family:arial;color:#000;" id="head_photos" onMouseOver="head_photos_over()" onMouseOut="head_photos_out()"><h4>Photos</h4></a></div>
...
<div style="position:fixed; left:88.2%; top:20%; z-index:3;"><a href="../fb_home/Settings.php" style="text-decoration:none;font-family:arial; color:#000;" id="head_settings" onMouseOver="head_settings_over()" onMouseOut="head_settings_out()"><h4> Account Settings </h4></a></div>
...
<div style="position:fixed; left:88.3%; top:24.5%; z-index:3;"><a href="../fb_home/feedback.php" style="text-decoration:none;font-family:arial; color:#000;" id="head_feedback" onMouseOver="head_feedback_over()" onMouseOut="head_feedback_out()"><h4> Feedback </h4></a></div>
...
<div style="position:fixed; left:88.3%; top:29.1%; z-index:3;"><a href="../fb_logout/logout.php" style="text-decoration:none;font-family:arial; color:#000;" id="head_logout" onMouseOver="head_logout_over()" onMouseOut="head_logout_out()"><h4> Logout </h4></a></div>
</div>
