...
<head>
    ...
    <LINK REL="SHORTCUT ICON" HREF="../fb_title_icon/logo.png" />
</head>
<body style="background-color:#f2f6fc">

<!--Head background-->
<div style="position:fixed;left:0;top:0; height:7%; width:100%; z-index:1; background:#001A33">   </div>
<!--Head fb text-->
<div style="position:fixed;left:4.05%;top:0.8%;font-size:25;font-weight:900; z-index:2;"> <a href="Home.php" style="color:#FFFFFF; text-decoration:none;" onMouseOver="on_head_fb_text()" onMouseOut="out_head_fb_text()">   <img src="../../fb_title_icon/logo.png" style="width:14%; height:9%;position:absolute;left:13.5%; top:1%;"/> </a> </div>
<!--Head fb text background-->
<div style="position:fixed;left:4%;top:1%; height:5%; width:8%; z-index:1; background:#001A33; display:none;" id="head_fb_text_backgraound">   </div>

<div style="position:fixed; left:12.7%; top:1.6%; z-index:1;">  <img src="background_file/background_icons/request.png">  </div>
<div style="position:fixed; left:14.7%; top:1.6%; z-index:1;"> <a href="Group_Message.php"> <img src="background_file/background_icons/messages.png"> </a> </div>
<div style="position:fixed; left:16.7%; top:1.6%; z-index:1;">  <img src="background_file/background_icons/notifications.png">  </div>
...
<form name="fb_search" action="Search_Display_submit.php" method="get" onSubmit="return bcheck()">
	<div style="position:fixed; left:19%; top:1.2%; z-index:1;"> <input type="text" name="search1" style="height:25; width:300;"  onKeyUp="searching();" id="search_text1" placeholder="Search for people" > </div>

	<div id="searching_ID"></div>

	<div style="position:fixed; left:42%;top:1.6%; z-index:1;">
...
<div style="position:fixed; left:71.8%; top:0.6%; z-index:1;">
	...
	<tr id="hedarname2">
		...
		<td style="padding-left:7;" id="head_img" > <a href="../fb_profile/Profile.php">  <img src="../../fb_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:27; width:25;"> </a> </td>

		<td id="head_name_bg"> <a href="../fb_profile/Profile.php" id="head_name_font" style="color:#DEDEEF; font-size:12; font-weight:900;font-family:arial; text-transform:arial,capitalize; text-decoration:none;"> &nbsp;  <?php echo $name; ?> &nbsp;</a> </td>
		<td style="color:#DEDEEF;"> | </td>
		<td id="head_home_bg"> <a href="Home.php" id="head_home_font" style="color:#DEDEEF; font-size:12; font-weight:900;font-family:arial; text-decoration:none;"> &nbsp; Home &nbsp; </a> </td>
        <td style="color:#DEDEEF;">|</td>
	</tr>
	</table>
</div>
...
<div style="position:fixed; left:97%; top:0.4%; z-index:1;"> <img src="background_file/background_icons/nexusae0_home_settings_icon2.png" height="35" width="35" onClick="close_option()"> </div>
        ...
        <div style="position:fixed; left:88%; top:5%; z-index:3;">
                 <a href="../fb_profile/Profile.php" style="text-decoration:none; font-family:arial;color:#000;" id="head_timeline" onMouseOver="head_timeline_over()" onMouseOut="head_timeline_out()" ><h4>Timeline</h4></a>
        </div>
        ...
        <div style="position:fixed; left:88%; top:10%; z-index:3;">
                <a href="../fb_profile/about.php" style="text-decoration:none; font-family:arial;color:#000;" id="head_about" onMouseOver="head_about_over()" onMouseOut="head_about_out()"><h4>About</h4></a>
        </div>
...
<div style="position:fixed; left:88.2%; top:15%;font-family:arial; z-index:3;"><a href="../fb_profile/photos.php" style="text-decoration:none; color:#000;" id="head_photos" onMouseOver="head_photos_over()" onMouseOut="head_photos_out()"><h4>Photos</h4></a></div>
...
<div style="position:fixed;font-family:arial; left:88.2%; top:20%; z-index:3;"><a href="Settings.php" style="text-decoration:none; color:#000;" id="head_settings" onMouseOver="head_settings_over()" onMouseOut="head_settings_out()"><h4> Account Settings </h4></a></div>

<div style="position:fixed; left:86.1%; top:27.5%;font-family:arial; z-index:3;"> <a href="feedback.php"> <img src="background_file/background_icons/icon-feedback.png" height="20" width="20" onMouseOver="head_feedback_over()" onMouseOut="head_feedback_out()"> </a> </div>
<div style="position:fixed; left:88.3%; top:24.5%;font-family:arial; z-index:3;"><a href="feedback.php" style="text-decoration:none; color:#000;" id="head_feedback" onMouseOver="head_feedback_over()" onMouseOut="head_feedback_out()"><h4> Feedback </h4></a></div>

<div style="position:fixed; left:86%; font-family:arial;top:32.5%; z-index:3;"> <a href="../fb_logout/logout.php"> <img src="background_file/background_icons/logout.png" height="20" width="20"  onMouseOver="head_logout_over()" onMouseOut="head_logout_out()"> </a> </div>
<div style="position:fixed; left:88.3%;font-family:arial; top:29.1%; z-index:3;"><a href="../fb_logout/logout.php" style="text-decoration:none; color:#000;" id="head_logout" onMouseOver="head_logout_over()" onMouseOut="head_logout_out()"><h4> Logout </h4></a></div>
</div>
...
<!--left part-->
<div style="position:fixed; left:1.2%; top:10.5%; z-index:1;">
	<table border="0">
	<tr>
		...
		<td> &nbsp; <a href="../fb_profile/Profile.php" onMouseOver="left_name_over()" onMouseOut="left_name_out()" style="color:#000000; font-size:15; font-weight:900;font-family:arial; text-transform:capitalize; text-decoration:none;" id="left_name">   <?php echo $name; ?> </a> </td>
	</tr>
	</table>
</div>
...
<div style="position:fixed; left:9%; top:33%;"> <a href="Home.php" style="text-decoration:none;font-family:arial; color:#000;" id="news_feed" onMouseOver="left_news_feed_over()" onMouseOut="left_news_feed_out()"> <h4>News Feed</h4> </a></div>
...
<div style="position:fixed; left:9%; top:37.2%;"><a href="../fb_profile/Profile.php" style="text-decoration:none;font-family:arial; color:#000;" id="timeline" onMouseOver="left_timeline_over()" onMouseOut="left_timeline_out()" ><h4>Timeline</h4></a></div>
...
<div style="position:fixed; left:9%; top:41.8%;"><a href="../fb_profile/about.php" style="text-decoration:none;font-family:arial; color:#000;" id="about" onMouseOver="left_about_over()" onMouseOut="left_about_out()"><h4>About</h4></a></div>
...
<div style="position:fixed; left:9%; top:46%;"><a href="../fb_profile/photos.php" style="text-decoration:none; font-family:arial;color:#000;" id="photos" onMouseOver="left_photos_over()" onMouseOut="left_photos_out()"><h4>Photos</h4></a></div>
...
<div style="position:fixed; left:9%; top:50%;"><a href="Group_Message.php" style="text-decoration:none; font-family:arial;color:#000;" id="group_message" onMouseOver="left_group_message_over()" onMouseOut="left_group_message_out()"><h4>Group Chat</h4></a></div>
...
<div style="position:fixed; left:9%; top:54.2%;"><a href="Settings.php" style="text-decoration:none;font-family:arial; color:#000;" id="settings" onMouseOver="left_settings_over()" onMouseOut="left_settings_out()"><h4>Settings</h4></a></div>


<!--left hr-->
<hr style="position:fixed;left:18%;top:4.8%;height:100%;width:0;">
<!--right hr-->
<hr style="position:fixed;left:82%;top:4.8%;height:100%;width:0;">
