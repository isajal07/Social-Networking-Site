...
?>
	...
	<!--Status-->
	<div style=" background:#f2f6fc; position:absolute; left:21%; top:8%; height:22%; width:41.4%; z-index:-1; box-shadow:1px 1px 1px 1px rgb(0,0,0);"> </div>
...
<div style=" background:#F2F2F2; position:absolute; left:21%; top:26.5%; height:6.5%; width:41.4%; z-index:-1;"> </div>
	...
	<div style="position:absolute; left:21.3%; top:11.5%;">
		<textarea style="height:100; font-family:arial;width:550;" name="post_txt" maxlength="511" placeholder="Post something..."></textarea>
...
<option value="Private"> Only me </option>
	...
	<div style="position:absolute; left:21.3%; top:11.5%;">
		<textarea style="height:100; width:550;" name="post_txt" maxlength="511" placeholder="Post something..."></textarea>
	</div>
    <input type="hidden" name="pic_post_time">
	<div style="position:absolute; left:50%; top:18.5%;">
	<select style="background: transparent; border-bottom:5px;" name="priority">
<option value="Public"> Public </option>
<option value="Private"> Only me </option>
</select> </div>
...
?>
	...
	?>
 	...
 	<tr>
		<td width="2%" style="padding-left:2;font-style:italic;" rowspan="2"> <img src="../../fb_users/<?php echo $user_gender; ?>/<?php echo $user_Email; ?>/Profile/<?php echo $user_pic; ?>" height="59" width="59">  </td>
		<td > </td>
		<td> </td>
		<td> </td>
	</tr>
	<tr>
		<td colspan="3" style="padding:7;font-family:arial;font-style:italic;font-weight:bold;"> <a href="../fb_view_profile/view_profile.php?id=<?php echo $post_user_id; ?>" style="text-transform:capitalize; text-decoration:none; color:#003399;" onMouseOver="post_name_underLine(<?php echo $postid; ?>)" onMouseOut="post_name_NounderLine(<?php echo $postid; ?>)" id="uname<?php echo $postid; ?>"> <?php echo $user_name; ?> </a>  </td>
		<td> </td>
		<td> </td>
		<td> </td>
	</tr>
...
?>
	...
	<td width="4%" style="padding-left:17;" bgcolor="#EDEFF4" rowspan="2">  <img src="../../fb_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:33; width:33;">    </td>
		<td bgcolor="#EDEFF4" colspan="2" style="padding-top:5;width:30%;">
